<div class="modal fade" id="newtask" tabindex="-1" aria-labelledby="newtaskLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form method="POST" action="taskbuild.php">
        <div class="modal-body">
          <div class="mb-3">
            <textarea class="form-control mb-3" placeholder="Description" rows="5" name="description"> </textarea>
          </div>
          <div>
            <div class="col-12">
              <input type="datetime-local" class="form-control" name="dateHeureLimite">
            </div>
          </div>
        </div>
