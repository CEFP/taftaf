    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="d-flex align-items-center justify-content-between">
          <a href="viewtask.php?id=<?php echo $idtache; ?>&amp;statut=1" class="btn btn-dark" value>
            En cours
          </a>
          <a href="viewtask.php?id=<?php echo $idtache; ?>&amp;statut=2" class="btn btn-dark">
            Fait
          </a>
          <a href="viewtask.php?id=<?php echo $idtache; ?>&amp;statut=3" class="btn btn-dark">
            Annulée
          </a>
          <a a href="viewtask.php?id=<?php echo $idtache; ?>&amp;statut=4" class="btn btn-dark">
            Reportée
          </a>
        </div>
      </div>
